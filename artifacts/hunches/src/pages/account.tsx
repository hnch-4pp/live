...
import {
  ...
  Clock, CheckCircle2, XCircle, Users, Hourglass,
} from "lucide-react";
...
function MyHunchesSection() {
  ...
  if (!loading && hunches.length === 0) return null;

  return (
    <div className="bg-card border border-border rounded-2xl overflow-hidden">
      {/* Header with tab pills */}
      <div className="px-6 py-4 border-b border-border flex items-center justify-between gap-4">
        <h2 className="text-sm font-semibold text-foreground">My Hunches</h2>
        ...
        {loading ? (
          ...
          shown.map((h) => {
            ...
            return (
              ...
              >
                {/* Thumbnail or category color swatch */}
