...
<body style="font-family:sans-serif;color:#111;max-width:520px;margin:0 auto;padding:24px">
  <p style="font-size:18px;font-weight:700;margin-bottom:4px">Nuevo reporte de error</p>
  ...
  <p style="font-size:12px;color:#aaa">Hunch — <a href="https://hunch.fan" style="color:#7c3aed">hunch.fan</a></p>
    ...
    const result = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        subject: `Nuevo reporte de error - hunch.fan`,
        html,
      }),
    });
    ...
    logger.error({ err }, "Bug report notification send failed");
  }
